...
public class NNLocalGroupFiltered {
    ...
    public NNLocalGroupFiltered(int _maxtrain, String[] _filter, NNBottomGroup _BootGroup, IdxStructure _Indexer, int _grouplength, boolean _verbose) {
        limitGroup[1] = 1;
        limitGroup[3] = 1;
        limitGroup[4] = 1;
        limitGroup[7] = 1;
    ...
    public void addTest(int d) {
     ...
     public  boolean filter(String radical){
