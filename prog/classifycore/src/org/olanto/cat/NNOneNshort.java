...
public class NNOneNshort {
    ...
    private static final short MINBYTE = -255;  // limit for compact implementation
    private static final short MAXBYTE = +255;
    ...
    static short[][] nnc;     // neuron net positive Winnow compact
...
//    static int[] docbag;          // active docbag (for train, correct, and evaluation)
    ...
    static void initWinnowPosCompact() {
        nnc = new short[maxused][maxgroup];
    ...
    static void avgLength() {
        ...
        alfaPn[0] = startwith;
        alfaNn[0] = startwith;
        float addneg=add+0.01f;
        for (int i = 0; i < MAXBYTE; i++) {  // init power of alfa

            alfaPn[i + 1] = alfaPn[i] * add;
            alfaNn[i + 1] = alfaNn[i] / addneg;  // min is not used symetric promotion and demotion
