...
/**
 * Une classe pour dï¿½finir les token (une dï¿½finition alpha numï¿½rique).
 *
 */
...
public class TokenCatNative implements TokenDefinition {
     ...
     * dï¿½finition symbole= commence avec une lettre (au sens unicode)
     * et n'est pas dans un tag <> (peut occasioner une erreur d'indexation dans les mauvais html)
     * s'arrï¿½te quand on rencontre autre chose qu'une lettre (au sens unicode)
     */
     ...
     * - mis en minuscule<br>
     * - tronquer ï¿½ la longueur fixï¿½e.<br>
     * - lemmatiser si le stemming est actif.<br>
     * @param id l'indexeur de rï¿½fï¿½rence
     * @param w le mot ï¿½ normaliser
     * @return un mot normalisï¿½
     */
