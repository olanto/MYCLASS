 ...
 *
 */
public class NNOneNBal {

    private static ExperimentBal collectResult;
     ...
     */
    public static ExperimentBal getCollectResult() {
     ...
     */
    public static void setCollectResult(ExperimentBal _collectResult) {
        ...
        for (int i = 0; i < docbag.length; i++) {
            ...
            if (iiii != NOT_FOUND && worduse[iiii] >= 0x4) {// if not discard
                ...
                for (int j = 0; j < maxgroup; j++) {
                    if (nnc[iiii][j] < 0)// negative
                    {
                        cumul[j] += (2*alfaNn[-nnc[iiii][j]]-alfaPn[nnc[iiii][j]]) * wsdf;
                    } else // positive
                    {
                        cumul[j] += (2*alfaPn[nnc[iiii][j]]-alfaNn[-nnc[iiii][j]]) * wsdf;
                    }
                }
            }
        }
