 ...
 *
 */
public class Experimentshort extends Object {
   ...
   //belong to this
    ...
    public Experimentshort(String experimentName,
            String pathfileSave,
            int nbproc,
            boolean inmemory,
            int categorylevel,
    ...
    public void doIt() {
        NNOneNshort.setCollectResult(this);
        NNOneNshort.setNB_PROC(nbproc);
        NNOneNshort.setINMEMORY(inmemory);
        NNOneNshort.TrainWinnow(categorylevel, prefix, repeatK, qlevel, add, minocc, maxocc, deltamin, deltamax, verbosetrain, testtrain, trainpart);

        if (maintest) {
            NNOneNshort.testWinnow4(maintestGroupdetail, maintestDocumentdetail, Nfirst);
        }
        if (multitest) {
            NNOneNshort.testWinnow4Multi(multitestGroupdetail, Nfirst);
        }

    }

    public static List<Experimentshort> loadSetOfExperiment(String fname) {
        expFileName = fname;
        Vector<Experimentshort> res = new Vector<Experimentshort>();
        try {
    ...
    public static void runSetOfExperiment(List<Experimentshort> list) {
        msg(".............................................................");
        try {
            OutputStreamWriter osr = new OutputStreamWriter(new FileOutputStream(expFileName + ".res"));
            BufferedWriter out = new BufferedWriter(osr);
            for (Experimentshort item : list) {
                item.doIt();
