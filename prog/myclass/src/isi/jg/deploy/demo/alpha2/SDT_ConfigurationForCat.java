...
public class SDT_ConfigurationForCat implements IdxInit{
    
    /** cr�e l'attache de cette classe.
     */
    public SDT_ConfigurationForCat(){}
     ...
     */
     public  void InitPermanent(){
       ...
       /** nbre d'object storage actif = 2^OBJ_PW2 */
        ...
        WORD_MINLENGTH=2;
        WORD_MAXLENGTH=40;
        WORD_DEFINITION=new SDT_TokenCatNative();
    ...
    public  void InitConfiguration(){
        ...
        // les directoire
        COMLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha2_sdt/common.log";
        DETLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha2_sdt/detail.log";

        String root=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha2_sdt";
        String root0=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha2_sdt";
