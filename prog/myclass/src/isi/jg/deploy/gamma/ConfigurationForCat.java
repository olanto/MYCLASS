...
public class ConfigurationForCat implements IdxInit{
     ...
     */
     public  void InitPermanent(){
       ...
       /** nbre d'object storage actif = 2^OBJ_PW2 */
        ...
        WORD_MINOCCKEEP=10;  // pour une indexation en deux passes
    ...
    public  void InitConfiguration(){
        ...
        // les directoire
        COMLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/frende/common.log";
        DETLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/frende/detail.log";

        String root=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/frende";
        String root0=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/frende/sto0";
