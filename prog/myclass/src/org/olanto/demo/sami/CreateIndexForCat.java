...
public class CreateIndexForCat {
    ...
    public static void main(String[] args) {
        ...
        id.indexdirOnlyCount(SenseOS.getMYCLASS_ROOT() + "MYCLASS_MODEL/sample/sami");// indexation du dossier 

        id.flushIndexDoc();  //  vide les buffers       

        Timer t2 = new Timer("doc bag build");
        id.indexdirBuildDocBag(SenseOS.getMYCLASS_ROOT() + "MYCLASS_MODEL/sample/sami");// indexation du dossier 
        t2.stop();
        id.flushIndexDoc();  //  vide les buffers       
        id.Statistic.global();
        id.close();
