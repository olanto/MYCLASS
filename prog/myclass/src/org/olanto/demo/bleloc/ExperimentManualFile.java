...
public class ExperimentManualFile {
    ...
    public static void main(String[] args) {
        ...
        String fntrain = SomeConstant.ROOTDIR + "SIMPLE_CLASS/sample/bleloc/classdata.txt.12.cat";
        String fntest = SomeConstant.ROOTDIR + "SIMPLE_CLASS/sample/bleloc/classdata.txt.parcours.cat";
