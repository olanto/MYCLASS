...
public class ExperimentManual {
    ...
    public static void main(String[] args) {
        ...
        // path to catalog
        String fntrain = SomeConstant.ROOTDIR + "MYCLASS_MODEL/sample/alpha/MAINGROUP_TRAIN.cat";
        String fntest = SomeConstant.ROOTDIR + "MYCLASS_MODEL/sample/alpha/EMPTY.cat";
        ...
        Experiment x = new Experiment(
                ...
                SomeConstant.ROOTDIR + "MYCLASS_MODEL/experiment/first/", //            String pathfileSave,
                8, //            int nbproc,
