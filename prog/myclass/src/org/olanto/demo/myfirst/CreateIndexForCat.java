...
public class CreateIndexForCat {
    ...
    public static void main(String[] args) {
        ...
        id.indexdirOnlyCount(SomeConstant.ROOTDIR + "MYCLASS_MODEL/sample/alpha");// indexation du dossier 

        id.flushIndexDoc();  //  vide les buffers       

        Timer t2 = new Timer("doc bag build");
        id.indexdirBuildDocBag(SomeConstant.ROOTDIR + "MYCLASS_MODEL/sample/alpha");// indexation du dossier 
        t2.stop();
        id.flushIndexDoc();  //  vide les buffers       
        id.Statistic.global();
        id.close();
