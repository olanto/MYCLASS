...
package org.olanto.demo.myfirstdirect;

import org.olanto.demo.myfirst.ConfigurationForCat;
...
public class BuildMNN{
    ...
    public static void main(String[] args)   {
       ...
       NNBottomGroup BootGroup=new NNBottomGroup(id,fntrain,fntest,NNOneN.CAT_MAINGROUP7,false,false);
        ...
        NNBuildTree.setDirectMode(true); // dont use indirection
        NNBuildTree.init(
        signature,
        ...
        1000,                      // nbr de réseaux
        30000,                     // somme de toutes les catégories de tous les réseaux
        1.06f,                     // alpha
