...
public class ConfigurationForCat implements IdxInit{
    ...
    public  void InitConfiguration(){
        ...
        // les directoire
        COMLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha/common.log";
        DETLOG_FILE = SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha/detail.log";

        String root=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha";
        String root0=SomeConstant.ROOTDIR+"SIMPLE_CLASS/data/alpha/sto0";
