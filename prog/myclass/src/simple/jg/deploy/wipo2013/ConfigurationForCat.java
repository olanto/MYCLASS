...
public class ConfigurationForCat implements IdxInit{
     ...
     */
     public  void InitPermanent(){
       ...
       /** nbre d'object storage actif = 2^OBJ_PW2 */
        ...
        WORD_MINOCCKEEP=64;  // pour une indexation en deux passes
    ...
    public  void InitConfiguration(){
        ...
        // les directoire
        COMLOG_FILE = "c:/PATDB/data/wipo2013/common.log";
        DETLOG_FILE = "c:/PATDB/data/wipo2013/detail.log";

        String root="c:/PATDB/data/wipo2013";
        String root0="c:/PATDB/data/wipo2013/sto0";
