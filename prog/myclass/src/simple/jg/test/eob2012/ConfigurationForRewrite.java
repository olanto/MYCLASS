...
public class ConfigurationForRewrite implements IdxInit{
    ...
    public  void InitConfiguration(){
        ...
        // les directoire
       COMLOG_FILE = "H:/EOB/EXP/"+SomeConstant.GROUP+"/DATARW/common.log";
        DETLOG_FILE = "H:/EOB/EXP/"+SomeConstant.GROUP+"/DATARW/detail.log";

        String root="H:/EOB/EXP/"+SomeConstant.GROUP+"/DATARW";
        String root0="H:/EOB/EXP/"+SomeConstant.GROUP+"/DATARW/sto0";
       IdxConstant.COMMON_ROOT=root;
        ...
        IdxConstant.QUERY_CACHE_SIZE=2000*MEGA;
